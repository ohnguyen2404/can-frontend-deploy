  ...
  return (
    <section id="tag-info-groups" className={`w-full ${styles.flexCenter} px-6 py-10 bg-white`}>
      <div className={`${containerStyle} bg-lightBlue mr-6 rounded-lg`}>
        ...
        <img src="/market.png" className={`object-fit max-w-[300px] max-h-[260px]`} />
      ...
      <div className={`${containerStyle} bg-lightPink mr-6 rounded-lg`}>
        ...
        <img src="/customer.png" className={`object-fit max-w-[240px] max-h-[260px]`} />
        <div className={paragraphStyle}>
      ...
      <div className={`${containerStyle} bg-lightBlue mr-6 rounded-lg`}>
        ...
        <img src="/profile.png" className={`object-fit max-w-[300px] max-h-[260px]`} />
        <div className={paragraphStyle}>
          <p>Hơn 3000 hồ sơ</p>
          <p>nhận được PR</p>
        </div>
      ...
      <div className={`${containerStyle} bg-lightPink mr-0 rounded-lg`}>
        ...
        <img src="/percent.png" className={`object-fit max-w-[300px] max-h-[260px]`} />
        <div className={paragraphStyle}>
